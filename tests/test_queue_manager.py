...
class TestQueueManager:
    ...
    @pytest.fixture
    def queue_manager(self, mock_rate_limiter, mock_gemini_client, mock_history_manager):
    ...
    async def test_add_generation_request(self, queue_manager, sample_params):
        ...
        request_id = await queue_manager.add_generation_request("test prompt", sample_params)
    ...
    @pytest.mark.asyncio
    async def test_add_request_rate_limited(self, queue_manager, sample_params, mock_rate_limiter):
    ...
    @pytest.mark.asyncio
    async def test_process_single_request_success(self, queue_manager, sample_params, mock_gemini_client, mock_history_manager):
    ...
    @pytest.mark.asyncio
    async def test_process_single_request_failure(self, queue_manager, sample_params, mock_gemini_client, mock_history_manager):
    ...
    @pytest.mark.asyncio
    async def test_retry_mechanism(self, queue_manager, sample_params, mock_gemini_client):
    ...
    @pytest.mark.asyncio
    async def test_max_retries_exceeded(self, queue_manager, sample_params, mock_gemini_client):
    ...
    @pytest.mark.asyncio
    async def test_rate_limit_handling(self, queue_manager, sample_params, mock_rate_limiter):
