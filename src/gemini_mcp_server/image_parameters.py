...
class ImageGenerationParameters(BaseModel):
    ...
    aspect_ratio: AspectRatio = Field(default=AspectRatio.SQUARE, description="Aspect ratio of the generated image")
    style: ImageStyle = Field(default=ImageStyle.REALISTIC, description="Style of the generated image")
    safety_level: SafetyLevel = Field(default=SafetyLevel.MODERATE, description="Content safety filtering level")
